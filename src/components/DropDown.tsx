  ...
  return (
    <>
      <div className='relative w-1/5'>
        <button
          type='button'
          className='flex justify-center items-center rounded-[1.25rem] border-2 border-main-blue p-4 text-sm text-main-blue font-bold gap-2'
          id='menu-button'
          onClick={() => {
        ...
        <AnimatePresence>
          {dropdown ? (
            <motion.div
              ...
              style={{ originY: 0 }}
              className='absolute w-full top-14 overflow-hidden rounded-2xl -shadow-basic z-20'
            >
