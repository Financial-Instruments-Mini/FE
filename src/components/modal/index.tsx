...
const Modal = ({ onCloseModal, children }: IModalProps) => {
  return (
    <>
      <section className='absolute z-50 top-0 right-0 bottom-0 left-0 opacity-40 bg-black' />
      <section className='absolute z-50 top-0 right-0 bottom-0 left-0 flex justify-center items-center p-16'>
